  ...
  <div>
    <div className="row">
      <div className="col-lg-12 col-md-12 col-sm-12">
        <p className="gray-bold-title">User Status</p>
      </div>
    </div>
    <div className="row">
      ...
      <div id="weekdays" className="col-lg-9 col-md-9 col-sm-12">
        <p id="weekdays-title">Weekdays</p>
        <div className="weekday-checkbox-wrapper">
          <Input
    ...
    <div className="row">
      ...
      <div
        className={`col-lg-6 col-md-6 col-sm-12 ${
          dangerZone.value ? "dz-true" : "dz-false"
        }`}
      >
        <input
